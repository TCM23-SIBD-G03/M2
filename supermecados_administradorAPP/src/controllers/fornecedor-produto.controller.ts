...
export class FornecedorProdutoController {
  ...
  async find(
    ...
    return this.fornecedorRepository.FornecedoresDoProduto(id).find(filter);
  }
  ...
  async create(
    ...
    return this.fornecedorRepository.FornecedoresDoProduto(id).create(produto);
  }
  ...
  async patch(
    ...
    return this.fornecedorRepository.FornecedoresDoProduto(id).patch(produto, where);
  }
  ...
  async delete(
    ...
    return this.fornecedorRepository.FornecedoresDoProduto(id).delete(where);
  }
}
