...
export class CompraProdutoController {
  ...
  async find(
    ...
    return this.compraRepository.listaCompra(id).find(filter);
  }
  ...
  async create(
    ...
    return this.compraRepository.listaCompra(id).create(produto);
  }
  ...
  async patch(
    ...
    return this.compraRepository.listaCompra(id).patch(produto, where);
  }
  ...
  async delete(
    ...
    return this.compraRepository.listaCompra(id).delete(where);
  }
}
