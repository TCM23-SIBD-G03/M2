...
export class ProdutoCompraController {
  ...
  async find(
    ...
    return this.produtoRepository.listaCompras(id).find(filter);
  }
  ...
  async create(
    ...
    return this.produtoRepository.listaCompras(id).create(compra);
  }
  ...
  async patch(
    ...
    return this.produtoRepository.listaCompras(id).patch(compra, where);
  }
  ...
  async delete(
    ...
    return this.produtoRepository.listaCompras(id).delete(where);
  }
}
