...
export class ProdutoSupermecadoController {
  ...
  async find(
    ...
    return this.produtoRepository.Stock(id).find(filter);
  }
  ...
  async create(
    ...
    return this.produtoRepository.Stock(id).create(supermecado);
  }
  ...
  async patch(
    ...
    return this.produtoRepository.Stock(id).patch(supermecado, where);
  }
  ...
  async delete(
    ...
    return this.produtoRepository.Stock(id).delete(where);
  }
}
