...
> {
  ...
  public readonly FornecedoresDoProduto: HasManyThroughRepositoryFactory<Produto, typeof Produto.prototype.id,
          Through,
          typeof Fornecedor.prototype.id
        >;
  ...
  constructor(
    ...
    this.FornecedoresDoProduto = this.createHasManyThroughRepositoryFactoryFor('FornecedoresDoProduto', produtoRepositoryGetter, throughRepositoryGetter,);
    this.registerInclusionResolver('FornecedoresDoProduto', this.FornecedoresDoProduto.inclusionResolver);
