...
declare const SupermecadoGerenteApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class SupermecadoGerenteApplication extends SupermecadoGerenteApplication_base {
