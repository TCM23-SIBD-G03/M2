...
export class SupermecadoProdutoController {
  ...
  async find(
    ...
    return this.supermecadoRepository.SupermecadoProduto(id).find(filter);
  }
  ...
  async create(
    ...
    return this.supermecadoRepository.SupermecadoProduto(id).create(produto);
  }
  ...
  async patch(
    ...
    return this.supermecadoRepository.SupermecadoProduto(id).patch(produto, where);
  }
  ...
  async delete(
    ...
    return this.supermecadoRepository.SupermecadoProduto(id).delete(where);
  }
}
